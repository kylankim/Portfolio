...
public class Check {
    ...
    //According to the rule of the game return the grid after a turn.
    public Grid check(){
        ...
        //System.out.println("Size of the point is "+point.size()+"\nrow");
        for(int i = 0; i< point.size(); i++){
            ...
            if(grid.getCellState(hash_row,hash_column)){
                ...
                //System.out.println(hash_row+","+hash_column+" to 0");
            }else{
                grid.setCellState(hash_row,hash_column,true);
                //System.out.println(hash_row+","+hash_column+" to 1");
            }
