...
def is_swap(score0, score1):
    ...
    if score0 == 1:
        ...
        while a < 100:
            if score0 * a == score1 or score0 == score1 * a:
                return True
            else:
                a += 1
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 or score1 <= goal:
        if player == 0:
            tot += take_turn(strategy0(tot,tot2), tot2, dice)
            if tot >= goal:
                if is_swap(tot, tot2) == True:
                    tot, tot2 = switch(tot,tot2)
                    say = say(tot,tot2)
                    return tot,tot2
                else:
                    say = say(tot,tot2)
        ...
        if player == 1:
            tot2 += take_turn(strategy1(tot2,tot), tot, dice)
            if tot2 >= goal:
                if is_swap(tot, tot2) == True:
                    tot, tot2 = switch(tot,tot2)
                    say = say(tot,tot2)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    aa, ma, tot3 = 10, 0, 0
    while aa > 0:
        av = make_averaged(roll_dice) (aa,dice)
        if ma == 0:
            ma = av
            tot3 = aa
            aa -= 1
