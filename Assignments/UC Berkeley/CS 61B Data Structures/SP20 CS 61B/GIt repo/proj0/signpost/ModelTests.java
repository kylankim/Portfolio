...
public class ModelTests {
    ...
    public void arrowDirectionTest() {
        ...
        assertEquals(6, model.arrowDirection(2, 0));
        assertEquals(5, model.arrowDirection(2, 3));
        assertEquals(8, model.arrowDirection(2, 1));

        model = new Model(tr(SOLN2));
        assertEquals(2, model.arrowDirection(0, 3));
        assertEquals(8, model.arrowDirection(2, 0));
        assertEquals(4, model.arrowDirection(2, 3));
