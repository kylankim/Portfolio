...
public class RuntimeQuiz {
    ...
    public static Asymptotic f2_notation = Asymptotic.BIG_OMEGA;
    public static Runtime f2_runtime = Runtime.LINEARITHMIC;
    public int f2(int n) {
        if (n <= 1) return n;
        f1(new int[n]);
    ...
    public static Asymptotic f5_notation = Asymptotic.BIG_OMEGA;
    ...
    public static Runtime f6_runtime = = Runtime.LINEARITHMIC;
    ...
    public static Asymptotic f7_notation = Asymptotic.BIG_OMEGA;
    public static Runtime f7_runtime = = Runtime.LINEARITHMIC;
    public static Asymptotic f7_omega_notation = Asymptotic.BIG_OMEGA;
    public static Runtime f7_omega_runtime = Runtime.LOG_N;
