...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        j_pos = self.getJailPosition()
        for pos in self.allPositions:
            self.beliefs[pos] *= self.getObservationProb(observation, pac_pos, pos, j_pos)
    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.allPositions:
            new_prob = self.getPositionDistribution(gameState, pos)

            for key in new_prob.keys():
                new_beliefs[key] += self.beliefs[pos] * new_prob[key]
