...
def roll_dice(num_rolls, dice=six_sided):
    ...
    rd_sum = 0
    trial = 0
    special_sum = 0 # Set a new variable
    while  trial < num_rolls:
        x = dice()
        if x == 1:
            special_sum = 1
        rd_sum += x
        trial += 1
    return special_sum or rd_sum #To prevent the game from stopping once the dice reaches 1 -> using "or"
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal or score1 < goal:
        if player == 0:
            ...
            elif score0 >= goal and not is_swap(score0,score1):
                say = say(score0,score1)
                return score0, score1
        ...
        if player == 1:
            ...
            if score1 >= goal and is_swap(score0, score1):
                score0, score1 = score1, score0
                say = say(score0,score1)
                return score0,score1
            elif score1 >= goal and not is_swap(score0,score1):
                say = say(score0,score1)
                return score0, score1
            elif is_swap(score0,score1):
                score0, score1 = score1, score0
