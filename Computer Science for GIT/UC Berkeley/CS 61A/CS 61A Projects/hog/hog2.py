...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num <= 10:
        ...
        #if make_averaged(roll_dice, num_samples) > highest_return: 
        if new_score > highest_return:
            highest_return = make_averaged(roll_dice, num_samples)
        #else: 
        num = num + 1
    return num
