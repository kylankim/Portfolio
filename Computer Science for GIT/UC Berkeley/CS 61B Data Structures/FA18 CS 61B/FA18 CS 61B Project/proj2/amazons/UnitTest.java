...
public class UnitTest {
    ...
    public void testdirection() {
        assertEquals(Square.sq(1, 1).direction(Square.sq(3, 3)), 1);
        assertEquals(Square.sq(1, 1).direction(Square.sq(0, 0)), 5);
        assertEquals(Square.sq(0, 0).direction(Square.sq(3, 3)), 1);
        assertEquals(Square.sq(0, 0).direction(Square.sq(0, 3)), 0);
    }

    @Test
    public void testisLegal() {
        Board b = new Board();
        assertTrue(b.isLegal(Square.sq(0, 2)));
        assertTrue(b.isLegal(Square.sq(0, 0)));
        ...
        assertTrue(b.isLegal(Square.sq(2, 0)));

        assertTrue(b.isLegal(Square.sq(2, 0), Square.sq(3, 1)));
        assertTrue(b.isLegal(Square.sq(2, 0), Square.sq(8, 6)));
        assertFalse(b.isLegal(Square.sq(2, 0), Square.sq(2, 0)));
        assertFalse(b.isLegal(Square.sq(2, 0), Square.sq(4, 0)));
        assertFalse(b.isLegal(Square.sq(2, 0), Square.sq(3, 0)));

        assertTrue(b.isLegal(Square.sq(2, 0),
                Square.sq(4, 2), Square.sq(3, 1)));
        assertTrue(b.isLegal(Square.sq(2, 0),
                Square.sq(4, 2), Square.sq(3, 2)));
        assertFalse(b.isLegal(Square.sq(2, 0),
                Square.sq(4, 0), Square.sq(3, 3)));
        assertTrue(b.isLegal(Square.sq(2, 0),
                Square.sq(4, 2), Square.sq(2, 0)));
    }
    ...
    public void testReachableFromIterator() {
        ...
        Board c = new Board();
        int count = 0;
        Iterator<Square> r = b.reachableFrom(Square.sq(0, 3), null);
        while (r.hasNext()) {
            c.put(SPEAR, r.next());
    ...
    public void testLegalMoveIterator() {
        ...
        Board c = new Board();
        int count = 0;
        Iterator<Move> l = b.legalMoves();
        while (l.hasNext()) {
            l.next();
            count++;
        }
        assertEquals(2137, count);
