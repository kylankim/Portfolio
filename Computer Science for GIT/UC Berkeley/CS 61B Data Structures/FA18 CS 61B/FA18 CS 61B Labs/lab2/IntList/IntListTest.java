...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        IntList B = IntList.list(1, 2, 3, 4, 7);
        IntList.squareListRecursive(B);
        assertEquals(IntList.list(1, 4, 9, 16, 49), B);

        IntList A = IntList.list(1, 2, 3);
        IntList.squareListRecursive(A);
        assertEquals(IntList.list(1, 4, 9), A);
    }
